...
class ForumMonitorConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'summon_panel_channel_id': self.summon_panel_channel_id,
            'summon_allowed_role_ids': self.summon_allowed_role_ids,
            'summon_panel_ping_enabled': 1 if self.summon_panel_ping_enabled else 0,
            'manual_notify_channel_id': self.manual_notify_channel_id,
            'manual_notify_role_ids': self.manual_notify_role_ids,
            'manual_notify_template': self.manual_notify_template,
    ...
    def from_row(cls, row: Dict[str, Any]) -> 'ForumMonitorConfig':
        ...
        return cls(
            ...
            notification_mode=str(row.get('notification_mode') or 'instant'),
            summon_panel_channel_id=str(row.get('summon_panel_channel_id')) if row.get('summon_panel_channel_id') else None,
            summon_allowed_role_ids=str(row.get('summon_allowed_role_ids')) if row.get('summon_allowed_role_ids') else None,
            summon_panel_ping_enabled=parse_bool(row.get('summon_panel_ping_enabled')),
            manual_notify_channel_id=str(row.get('manual_notify_channel_id')) if row.get('manual_notify_channel_id') else None,
            manual_notify_role_ids=str(row.get('manual_notify_role_ids')) if row.get('manual_notify_role_ids') else None,
            manual_notify_template=row.get('manual_notify_template') if row.get('manual_notify_template') else None,
    ...
    def to_json(self) -> str:
        ...
        return json.dumps({
            ...
            'summon_panel_channel_id': self.summon_panel_channel_id,
            'summon_allowed_role_ids': self.summon_allowed_role_ids,
            'summon_panel_ping_enabled': self.summon_panel_ping_enabled,
            'manual_notify_channel_id': self.manual_notify_channel_id,
            'manual_notify_role_ids': self.manual_notify_role_ids,
            'manual_notify_template': self.manual_notify_template,
            'created_at': self.created_at.isoformat() if self.created_at else None,
